				...
				<div class="col-lg-8">
					<div class="card shadow-lg border-0 rounded-lg mt-5">
						<div class="card-header">
							<h3 class="text-center font-weight-light my-4">Cập nhật thông tin</h3>
						</div>
						<div class="card-body">
									...
									<div class="col-md-6">
										<div class="form-floating mb-3">
											<input class="form-control" type="text" name="UserID"
												value="${userModel.userID}" readonly="readonly" /> <label>Mã nhân viên</label>
										</div>
										<div class="form-floating mb-3">
											<input class="form-control" type="text" name="FirstName"
												value="${userModel.firstName}" /> <label>Tên nhân viên</label>
										</div>
										<div class="form-floating mb-3">
										...
										<div class="form-floating mb-3">
											<input class="form-control" type="text" name="Gender"
												value="${userModel.gender}" /> <label>Giới tính</label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-floating mb-3">
										...
										<div class="form-floating mb-3">
											<input class="form-control" type="text" name="Cid"
												value="${userModel.cid}" /> <label>Căn cước công dân</label>
										</div>	
										<div class="form-floating mb-3">
